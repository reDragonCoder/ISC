...
RESET:
    ...
    LDI R16, 0xFF         ; Configurar todos los pines de PORTB como salida (para selecci�n de displays)
    OUT DDRB, R16
...
INICIO:
    LDI R20, 0xF8         ; Valor que representa el n�mero "7" en display de 7 segmentos 
