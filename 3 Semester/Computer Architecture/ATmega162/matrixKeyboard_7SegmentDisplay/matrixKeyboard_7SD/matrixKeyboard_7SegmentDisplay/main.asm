...
; Ubicamos la direcci�n de la TABLA Z=HIGH:LOW (R31:R30) donde est�n almacenados los c�digos del KeyPad
...
F1_C2:
    CBI     PORTA, 4
    INC     R17              ; Aumentamos en 1 el conteo para la posici�n del dato de la tabla
...
DatoTabla:
    ; R17 contiene la posici�n de la tecla en el teclado (fila * 4 + columna)
    ; El �ndice de la tabla se calcula como R17

    ADD     R30, R17         ; Sumamos la posici�n de la tecla a la parte baja del registro Z
...
; Tabla de c�digos para el display 7 segmentos (hexadecimal)
TABLA:
