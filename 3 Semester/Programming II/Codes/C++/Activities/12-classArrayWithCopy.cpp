...
int main(){
   //implementations for testing the class
    ...
    //static object copy
    cout<<endl<<"I'm the static object copy";
    Array arrayCopy(staticArray);
    staticArray.print();
    sumatory=arrayCopy.sumatory();
    cout<<endl<<"The sumatory of the values in the array is: "<<sumatory<<endl;
    smallest=arrayCopy.smallest();
    cout<<"The smallest number in the array is: "<<smallest<<endl;
    average=arrayCopy.average();
    cout<<"The average of the values in the array is: "<<average<<endl;
