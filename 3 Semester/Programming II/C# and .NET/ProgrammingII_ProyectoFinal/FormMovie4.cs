    ...
    public partial class FormMovie4 : Form
    {
        ...
        public FormMovie4(string img, string user)
        {
            ...
            try
            {
                ...
                btnAddCartMovie4.Visible = true;
                this.txtPrice4.Text = Convert.ToString(aux.Precio);
                this.txtStock4.Text = Convert.ToString(aux.Stock);
                this.rtxtMovie4.Text = aux.About;
                id = aux.Id;
        ...
        private void btnAddCartMovie4_Click(object sender, EventArgs e)
        {
            string guest = "guest";
            if (userHere == guest)
            {
        ...
        private void FormMovie4_Load(object sender, EventArgs e)
        {
